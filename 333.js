...
//<![CDATA[
$( "span:contains('Intro'),span:contains('Verse'),span:contains('Chorus'),span:contains('Interlude'),span:contains('Ending'),span:contains('Reff'),span:contains('Bridge'),span.contains('Rapp')").addClass('cc');
//]]>
